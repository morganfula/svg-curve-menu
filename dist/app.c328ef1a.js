...
var menuToggle = document.querySelector('.menu-tog');
...
var toggle = false; // Start SVG at bottom of screen
...
var animate = function animate() {
  if (toggle) {
    y = lerp(y, 0, 0.055);
    c = lerp(c, 0, 0.075);
    path.setAttribute('d', "M 0 ".concat(y, " L 0 100 100 100 100 ").concat(y, " C ", 50, " ").concat(c, ", ", 50, " ").concat(c, ", 0 ").concat(y));
  } else {
    y = lerp(y, 100, 0.055);
    c = lerp(c, 100, 0.075);
    path.setAttribute('d', "M 0 ".concat(y, " L 0 100 100 100 100 ").concat(y, " C 50 ").concat(c, ", ", 50, " ").concat(c, ", 0 ").concat(y));
...
},{"gsap":"node_modules/gsap/index.js"}],"../../../../.nvm/versions/node/v15.14.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
